  ...
  $('#onegeology').find('li.li-layer').click(function() {
      ...
      if(id == 'layer6') {
          ...
          if($(this).hasClass('layer-on')) {
              layer6 = map.data('mapQuery').layers({label:'One Geology North', type:'tms',url: 'http://mapproxy.geodan.nl/mapproxy/tms/',layername:'north'})
          ...
          var layer7;
          if($(this).hasClass('layer-on')) {
              layer7 = map.data('mapQuery').layers({label:'One Geology South', type:'tms',url: 'http://mapproxy.geodan.nl/mapproxy/tms/',layername:'south'})
          ...
          var layer8;
          if($(this).hasClass('layer-on')) {
              layer8 = map.data('mapQuery').layers({label:'One Geology West', type:'tms',url: 'http://mapproxy.geodan.nl/mapproxy/tms/',layername:'west'})
          ...
          var layer9;
          if($(this).hasClass('layer-on')) {
              layer9 = map.data('mapQuery').layers({label:'One Geology Center', type:'tms',url: 'http://mapproxy.geodan.nl/mapproxy/tms/',layername:'center'})
